...
// console.log("sele",selectedVideo);
                    ...
                    return <div key={video.id} className="relative mb-10 sm:px-4">
                        ...
                        <div className="relative">
                            <img
                                ...
                                alt={`Video Thumbnail`}
                            />
                            {/* {console.log(new URL(video.videoUrl).pathname.substring(1))} */}
                            {/* {console.log(`${new URL(video.videoUrl).hostname === "www.youtube.com" ||"youtube.com" ? new URL(video.videoUrl).searchParams.get('v') : new URL(video.videoUrl).pathname.substring(1)}`)} */}
                            <MdPlayCircle
