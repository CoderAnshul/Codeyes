    ...
    return (
        <div className={`border border-black rounded-[70px] bg-[#f0ead8] pb-14 md:pb-32 overflow-hidden`}>
            <div className={`px-10 py-14 md:py-32 md:!pb-20 flex justify-center`}>
                ...
                <h2 className={`text-2xl sm:text-3xl sm:text-[52px] font-semibold z-10 relative`}>Hey!
                        <span className="inline-block ml-2 mr-3">
                            <SvgIllustration />
                        </span>
                        We're Codeyes Media</h2>
...
const SvgIllustration = () => (
    <img
    src="/image/home/waving-hand_9837221.png"
    alt="Illustration"
