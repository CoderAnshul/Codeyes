...
export default function Footer() {
    ...
    return (
        <>
            ...
            <div className="border custom_container !py-0 border-black bg-[#cbdec6] overflow-hidden mt-10 rounded-[70px] mb-10">
                <div className="md:px-[70px] !bg-[#fbfaf5] grid md:grid-cols-6 border-b border-black">
                    ...
                    <div className="col-span-3">
                        <div className="flex w-full h-full md:ml-[70px] max-md:border-t border-black">
                           <Link to="https://in.linkedin.com/company/codeyes-media/" className={`border-r hover:text-[#ffde8b] max-md:py-6 md:border-l border-black w-full h-full flex items-center justify-center text-3xl`}><FaLinkedin /></Link>
                                                       <Link to="https://www.facebook.com/codeyesmedia/" className={`border-r hover:text-[#ffde8b] max-md:py-6 border-black w-full h-full flex items-center justify-center text-3xl`}><FaFacebook /></Link>
                                                       <Link to="https://api.whatsapp.com/send?phone=8849723987" className={`border-r hover:text-[#ffde8b] max-md:py-6 border-black w-full h-full flex items-center justify-center text-3xl`}><FaWhatsapp /></Link>
                                                       <Link to="https://www.instagram.com/codeyesmedia/" className={` w-full  hover:text-[#ffde8b] max-md:py-6 h-full flex items-center justify-center text-3xl`}><FaInstagram /></Link>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-span-1 space-y-3 mb-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <form onSubmit={handleSubmit} className="border hidden md:block border-black rounded-full overflow-hidden relative">
                                    ...
                                    />
                                    <button type="submit" className="border border-r-0 border-black rounded-full bg-[#ffde8b] p-2 absolute right-0 h-full w-[65px]">
