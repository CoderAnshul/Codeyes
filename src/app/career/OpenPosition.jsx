...
const OpenPosition = () => {
  ...
  useEffect(() => {
    const fetchCareer = async () => {
      try {
        const response = await axios.get(`${BASE_URL}/all-career?organizationId=codeyes_media`);
// console.log(response?.data?.data)
  ...
  const showSlider = (career,index)=>{
    if(index%3===0){
      return <SwiperSlide className="slide bg-[#d2ebf8]" style={{ width: '100%', height: '100%', objectFit: 'cover' }}>
      <div className='grid grid-cols-12 gap-y-5 lg:gap-x-24'>
        ...
        <div className='hidden lg:block   col-span-12 lg:col-span-5 xl:col-span-4'>
          <img src={career.image} alt='' className='object-cover rounded-3xl h-[500px] w-[385px]' />
        </div>
        <div className='col-span-12 lg:col-span-6'>
          <div className='pt-4 lg:pt-12'>
            <div className=''>
              <h2 className='text-4xl lg:text-5xl font-semibold'>{career.title}</h2>
            
            </div>
            <div className='pt-6'>
              <div className='overflow-hidden'>
                <h4 className='border-b border-black text-xl font-semibold pb-2'>{career.description}</h4>
      ...
      return  <SwiperSlide className="slide bg-[#cbdec6] max-md:!p-5">
      <div className='grid grid-cols-12 gap-10'>
          ...
          <div className='grid grid-cols-12 lg:gap-x-5 gap-y-5 md:gap-y-10 mt-10'>
            <div className='col-span-12 '>
              <div className='space-y-5'>
                ...
                <p className='max-sm:w-[80%]'>{career.description}</p>
              </div>
            </div>            
           <ApplyNow />
          </div>
        ...
        <div className='hidden lg:block col-span-6'>
          <div className='relative pl-20 pt-20'>
            <img src={career.image} alt='' className='relative w-[430px] rounded-3xl h-[290px] object-cover z-10' />
      ...
      return  <SwiperSlide className="slide max-md:!p-5" style={{ background: `url(/image/home/bacground-img.png)` }}>
      <div className='grid grid-cols-12 gap-10'>
        <div className='col-span-12 lg:col-span-6 pt-2 md:pt-10 lg:pl-10'>
          <h2 className='text-4xl lg:text-5xl font-semibold'>{career.title}</h2>
          <div className='grid grid-cols-12 lg:gap-x-5 gap-y-5 md:gap-y-10 mt-10'>
        ...
        <div className='hidden lg:block col-span-6'>
          <div className='relative pl-20 '>
            <img src={career.image} alt='' className='relative w-[340px] h-[600px] rounded-3xl object-cover z-10' />
