      ...
      <div className="flex flex-col gap-16">
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-4">
            <p className="uppercase hover:text-[#ffde8b] cursor-pointer text-sm" onClick={() => handleALLCategoryClick()}>
              All
            </p>
            {categories.map((cat) => {
              return (
                <p className="uppercase hover:text-[#ffde8b] cursor-pointer text-sm" key={cat.id} onClick={() => handleCategoryClick(cat.name)}>
                  {cat.name}
                </p>
              );
            })}
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-4 flex-wrap">
            <p className="uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#ffde8b] hover:text-white cursor-pointer text-sm" onClick={() => handleALLCategoryClick()}>
              All
            </p>
            {tags.map((tag) => {
              return (
                <p
                  className="uppercase border border-black w-fit rounded-full py-1 px-4 hover:bg-[#ffde8b] hover:text-white cursor-pointer text-sm"
