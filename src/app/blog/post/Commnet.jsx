    ...
    <>
      <div>
        <div className={`flex flex-wrap sm:flex-nowrap gap-5 sm:space-x-4 mb-8 ${comment._id === 2 ? "ml-8 sm:ml-28" : ""}`}>
          <div className="w-[100px] h-[100px] rounded-full bg-[#ffde8b] grid place-items-center text-white text-6xl font-bold">{comment.user[0]}</div>
        ...
        {comment.replies.length > 0 &&
          comment.replies.map((reply) => (
            <div key={reply._id} className={`flex flex-wrap sm:flex-nowrap gap-5 sm:space-x-4 mb-8 ${"ml-8 sm:ml-28"}`}>
              <div className="w-[100px] h-[100px] rounded-full bg-[#ffde8b] grid place-items-center text-white text-6xl font-bold">{reply.user[0]}</div>
              <div className="sm:flex-1">
                <div className="mb-2">
                  <span className="text-gray-500 text-sm">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-[90%] sm:w-[50%]">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button type="submit" className="px-4 py-2 bg-[#ffde8b] text-white rounded-lg hover:bg-[#e68a50]">
                  Post Comment
                </button>
              </div>
            </form>
